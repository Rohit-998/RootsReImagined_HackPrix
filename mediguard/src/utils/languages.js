...
export const REPORT_PROMPTS = {
  'hi-IN': {
    welcome: 'मेडीगार्ड में आपका स्वागत है। कृपया फार्मेसी का नाम बताएं।',
  ...
  'ta-IN': {
    welcome: 'மெடிகார்டுக்கு உங்களை வரவேற்கிறோம். தயவுசெய்து மருந்தகத்தின் பெயரைக் கூறுங்கள்.',
  ...
  'te-IN': {
    welcome: 'మెడిగార్డ్‌కు స్వాగతం. దయచేసి ఫార్మసీ పేరు చెప్పండి.',
  ...
  'bn-IN': {
    welcome: 'মেডিগার্ডে আপনাকে স্বাগত। অনুগ্রহ করে ফার্মেসির নাম বলুন।',
  ...
  'mr-IN': {
    welcome: 'मेडिगार्डमध्ये आपले स्वागत आहे. कृपया फार्मसीचे नाव सांगा.',
  ...
  'gu-IN': {
    welcome: 'મેડિગાર્ડમાં તમારું સ્વાગત છે. કૃપા કરીને ફાર્મસીનું નામ જણાવો.',
  ...
  'kn-IN': {
    welcome: 'ಮೆಡಿಗಾರ್ಡ್‌ಗೆ ಸುಸ್ವಾಗತ. ದಯವಿಟ್ಟು ಫಾರ್ಮಸಿಯ ಹೆಸರನ್ನು ತಿಳಿಸಿ.',
  ...
  'ml-IN': {
    welcome: 'മെഡിഗാർഡിലേക്ക് സ്വാഗതം. ഫാർമസിയുടെ പേര് പറയുക.',
  ...
  'pa-IN': {
    welcome: 'ਮੈਡੀਗਾਰਡ ਵਿੱਚ ਤੁਹਾਡਾ ਸੁਆਗਤ ਹੈ। ਕਿਰਪਾ ਕਰਕੇ ਫਾਰਮੇਸੀ ਦਾ ਨਾਮ ਦੱਸੋ।',
  ...
  'or-IN': {
    welcome: 'ମେଡିଗାର୍ଡକୁ ସ୍ଵାଗତ। ଦୟାକରି ଫାର୍ମାସୀର ନାମ କୁହନ୍ତୁ।',
