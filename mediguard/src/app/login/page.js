...
export default function Login() {
  ...
  return (
    <>
      ...
      <AuthLayout title="Welcome Back" subtitle="Log in to verify medicine authenticity.">
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          <div className="auth-field">
            ...
            <div className="auth-forgot">
              <Link href="/forgot-password" className="auth-link" style={{ fontWeight: 500, fontSize: '0.9rem' }}>
                Forgot Password?
              </Link>
            </div>
          </div>
          ...
          <button type="submit" className="auth-submit" disabled={loading}>
            {loading ? <Loader2 size={18} style={{ display: 'inline', animation: 'spin 1s linear infinite' }} /> : 'Continue'}
          </button>
        </form>
